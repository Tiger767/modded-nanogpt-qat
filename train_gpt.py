...
def load_config():
    parser = argparse.ArgumentParser(description="Train GPT with quantization options")
    # Default to normal if no config provided
    parser.add_argument('--config', type=str, default='configs/normal.json', help='Path to quantization config json') 
    
    # Parse known args to avoid conflict with torch.distributed args
    args, _ = parser.parse_known_args()
    
    print(f"Loading quantization config from: {args.config}")
...
# Weights
ENABLE_MLP_QUANTIZATION = _config.get("ENABLE_MLP_QUANTIZATION", False)
ENABLE_ATTN_QUANTIZATION = _config.get("ENABLE_ATTN_QUANTIZATION", False)
ENABLE_ATTN_PROJ_QUANTIZATION = _config.get("ENABLE_ATTN_PROJ_QUANTIZATION", False)

# Activations
ENABLE_MLP_ACT_QUANTIZATION = _config.get("ENABLE_MLP_ACT_QUANTIZATION", False)
ENABLE_MLP_PRE_ACT_QUANTIZATION = _config.get("ENABLE_MLP_PRE_ACT_QUANTIZATION", False)
ENABLE_EXTREME_MLP_ACT_QUANTIZATION = _config.get("ENABLE_EXTREME_MLP_ACT_QUANTIZATION", False)
ENABLE_EXTREME_PRE_MLP_ACT_QUANTIZATION = _config.get("ENABLE_EXTREME_PRE_MLP_ACT_QUANTIZATION", False)
ENABLE_ATTN_ACT_QUANTIZATION = _config.get("ENABLE_ATTN_ACT_QUANTIZATION", False)
ENABLE_ATTN_PRE_ACT_QUANTIZATION = _config.get("ENABLE_ATTN_PRE_ACT_QUANTIZATION", False)
ENABLE_EXTREME_ATTN_ACT_QUANTIZATION = _config.get("ENABLE_EXTREME_ATTN_ACT_QUANTIZATION", False)
ENABLE_EXTREME_PRE_ATTN_ACT_QUANTIZATION = _config.get("ENABLE_EXTREME_PRE_ATTN_ACT_QUANTIZATION", False)
